...
class _AddCourseState extends State<AddCourse> {
  ...
  Future<void> _createNewCourse() async {
    ...
    // Create course with empty ID (will be generated by provider/API)
    final course = _createCourse('', userId);

    // Use the provider which has all the debug logging
    final error = await courseProvider.addCourse(course);
